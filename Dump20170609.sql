CREATE DATABASE  IF NOT EXISTS `laps` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `laps`;
...
INSERT INTO `user` VALUES (10001,'ad1','ad1','Admin','One','Superuser'),(10002,'Alice','alice123','Alice','Avery','Administrative'),(10003,'Bert','bert123','Bert','Bob','Professional'),(10004,'Cindy','cindy123','Cindy','Class','Administrative'),(10005,'Dan','dan123','Dan','Brown','Professional'),(10006,'Elise','elise123','Elise','Edward','Professional'),(10007,'Faye','faye123','Faye','Wong','Administrative');
...
-- Dump completed on 2017-06-09 12:49:43
